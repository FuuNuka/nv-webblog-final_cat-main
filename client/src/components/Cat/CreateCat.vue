<template>
  <div class="container createcat box">
    ...
    <form v-on:submit.prevent="createCat">
      <p>About: <input type="text" v-model="cat.brand" /></p>
      ...
      <p>Category: <input type="text" v-model="cat.category" /></p>
      <p>Price: <input type="text" v-model="cat.price" /></p>
      <p><button type="submit">create Catfood</button></p>
    </form>
  </div>
</template>
<script>
